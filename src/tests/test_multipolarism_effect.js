...
import { initializeGame, playCard, endTurn } from '../gameLogic/main';
import { processEffects } from '../gameLogic/effectHandler';
import { EffectType, TriggerType, PlayerId } from '../gameLogic/constants';
...
describe('多極主義 (Multipolarism) Card Effect', () => {
  ...
  test('1. Placement effect: Halves scale and adds Money card with durability equal to half of the original scale', () => {
    ...
    gameState = processEffects(gameState);
