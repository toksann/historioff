    ...
    <div className="info-modal-overlay">
      <div className="info-modal-content">
        ...
        <div className="info-modal-body">
          ...
          <h3>Version 0.2.2 (2026/03/xx)</h3>
          <ul>
            <li><font color="yellow">画面調整</font>：新UIの適用により全体のグラフィックを調整</li>
            <li><font color="yellow">機能追加</font>：カードを獲得する効果を持つカードに「関連カードの表示機能」を追加</li>
            <li><font color="yellow">機能追加</font>：タイトル画面に「お問い合わせ」「アンケート」「免責事項」を追加</li>
