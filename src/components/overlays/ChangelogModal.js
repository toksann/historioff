    ...
    <div className="info-modal-overlay">
      <div className="info-modal-content">
        ...
        <div className="info-modal-body">
          ...
          <h3>Version 0.2.2 (2026/03/11)</h3>
          <ul>
            ...
            <li>　「資本主義」：ターン開始時効果に「自分の手札、デッキのすべてのカードの必要規模+6」と、場の財にダメージを与える前に「自分の場の財の数と同じだけ意識をプラス」を追加。自分の財カードに与えるダメージを場の財のうち最も低い耐久値の値に変更。また、ダメージ後に「場に残っている財カード」の耐久値+2する効果を追加。</li>
            ...
            <li>　「多極主義」：必要規模を60→40に変更。獲得するマネーの耐久値と減少する規模を「現在規模の50%→75%」に変更。イデオロギー捨て札時にデッキからカードを2枚引く効果を追加。</li>
            <li>　　変更経緯：ターン終了時効果の発動条件を満たしやすくしつつ、加える「マネー」の耐久値の実質的な維持と必要規模の低下による使いやすさ向上のため。</li>
            <li>　「環境主義」：ターン開始時効果を「場の財が3以上あれば自分の意識+3」から「場の財が3以上あれば自分の意識+2、相手の意識-1」に変更。</li>
            <li>　　変更経緯：彼我の期待される意識差を維持しつつ、誘発する効果の種類を増やすため。また、モチーフへの解釈を調整したため。</li>
            <li>　「社会主義」：「マネー」使用時の財カードの耐久値+効果を2→5に変更し、ターン開始時効果に「手札とデッキの必要規模+3」を追加。</li>
            <li>　　変更経緯：耐久値加算効果の向上により使用感の向上を軸に調整したため。</li>
            <li>　「共産主義」：ターン開始時効果に「手札の古いカードを1枚捨て札にする」を追加。</li>
            <li>　　変更経緯：場の財カードが手札に戻る効果を補助しつつ、効果全体の均衡を取るため。</li>
            <li>　「リバタリアニズム」：「マネー」以外のカードを出すときの効果に、「相手の意識-1」を追加。ターン開始時効果に「デッキからカードを1枚引く」を追加。</li>
            <li>　　変更経緯：「自由主義」トークンにおける役割を明確にし、より尖った性能とするため。</li>
          </ul>
